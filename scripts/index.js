...
const arrowRightInButton = document.querySelector(
  ".slider-roads__icon_action_next"
);
...
function changeTheme() {
  if (numberTheme === 0) {
    ...
    arrowRightInButton.classList.add(
      "slider-roads__icon_theme_dark-other-direction"
    );
    ...
    document
      .querySelector(".container__line")
      .classList.add("container__line_theme_dark");
    ...
    arrowRightInButton.classList.remove(
      "slider-roads__icon_theme_dark-other-direction"
    );
    ranges.forEach(function (item) {
      item.value = "0";
    ...
    document
      .querySelector(".container__line")
      .classList.remove("container__line_theme_dark");
    document.querySelectorAll(".switch__icon-light").forEach((item) => {
...
function moveFromRight() {
  ...
  listRoads[1].style.left =
    parseInt(getComputedStyle(listRoads[1]).left, 10) - 1470 + "px";
  listRoads[2].style.left =
    parseInt(getComputedStyle(listRoads[2]).left, 10) - 1470 + "px";
  listRoads[1].style.visibility = "hidden";
  listRoads[0].style.left =
    parseInt(getComputedStyle(listRoads[0]).left, 10) + 2940 + "px";
...
function moveFromLeft() {
  ...
  listRoads[1].style.left =
    parseInt(getComputedStyle(listRoads[1]).left, 10) + 1470 + "px";
  listRoads[0].style.left =
    parseInt(getComputedStyle(listRoads[0]).left, 10) + 1470 + "px";
  listRoads[1].style.visibility = "hidden";
  listRoads[2].style.left =
    parseInt(getComputedStyle(listRoads[2]).left, 10) - 2940 + "px";
...
function hideExtraCards() {
  ...
  bikesCardsActive
    ...
    .classList.remove("card_invisible");
...
function changeCard(lengthMovement) {
  ...
  if (
    (lengthMovement > 0 && indexCardActive < 2) ||
    (lengthMovement < 0 && indexCardActive > 0)
  ) {
    ...
    bikeCardActive =
      bikesCardsActive.querySelectorAll(".card")[indexCardActive];
...
languageLinkActive.addEventListener("click", (event) => {
  event.preventDefault();
});
